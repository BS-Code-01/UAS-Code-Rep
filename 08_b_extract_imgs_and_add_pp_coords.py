...
root = "D:/UAV-Befliegungen/210904_zuHauseNebenan/"

# CSV-Datei mit den korrigierten GNSS-Koordinaten
# und den zugehörigen Videozeitpunkten.
csv_file_read = root + "02_logs/Versuch_211105/00000052_2.csv"
...
with open(csv_file_read, "r") as csv_file_read_opened:
    ...
    for row in csv_file_read_opened.readlines()[1:]:
        ...
        Q = int(row_content[5])
        # Nur Positionslösungen mit Q=2 (float) werden weiterverarbeitet.
...
while rval:
    ...
    if counter % 1 == 0:
        ...
        if timestamp in list(timestamps_vid_dictio.keys()):
            ...
            #TODO: Klären, ob alles außer gps_ifd weg kann.
            exif_dict = \
            ...
            if counter % 20 == 0:
                ...
                # Geokodierung vorgenommen.
                # TODO: Klären, ob Bilder trotzdem exportiert werden sollen.
                # print("Fehler")
                # pass
